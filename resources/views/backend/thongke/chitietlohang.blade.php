...
<div class="row">
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
                <a href="{!! URL::route('admin.nhaphang.nhapngay') !!}">
                  <div class="panel-footer">
                      <span class="pull-left">Nhập hàng hôm nay</span>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-green">
            <div class="panel-heading">
                <div class="row">
                  <a href="{!! URL::route('admin.nhaphang.nhaphangtuan') !!}">
                    <div class="panel-footer">
                        <span class="pull-left">Nhập hàng tuần @if(isset($tuan)){{$tuan}}@endif tháng @if(isset($thang)){{$thang}}@endif</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
                    </div>
                  </a>  
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <div class="row">
                  <a href="{!! URL::route('admin.nhaphang.nhaphangthang') !!}">
                    <div class="panel-footer">
                        <span class="pull-left">Nhập hàng tháng @if(isset($thang)){{$thang}} @endif</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
                    </div>
                  </a>
...
<!-- /.row -->
    <section class="wrapper" style="margin-top:-20px">
      ...
      <a href="{!! URL::route('admin.nhaphang.bcchitietnh') !!}"> <h4 class=" text-center" >Chi tiết nhập hàng</h4></a>
      @if(isset($hn))
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="min-width:600px">
          <div class="modal-body pd-20 pd-sm-10">
            ...
            <form action="{!! URL::route('admin.nhaphang.nhaphangtuychon') !!}" method="POST">
...
<div class="row">
      <div class="col-sm-12">
          ...
          <center><a href="{!! URL::route('admin.thongke.congno') !!}"><h2 style="color:red"><b>BÁO CÁO NHẬP HÀNG</b></h2></a></center><hr>
            <div class="panel-body">
                <div class="adv-table">
                <table >
                  <thead>
                    <tr class="text-center">
                      ...
                      <td style="border:thin blue solid;" width="200px"><strong>Ngày nhập</strong></td>
                      <td style="border:thin blue solid;" width="100px"><strong>Mã lô hàng</strong></td>
                      ...
                      <td style="border:thin blue solid;" width="150px" ><strong>Thành tiền</strong></td>
                    </tr>
                  ...
                  <?php $count = 0; ?>
                    @foreach($dtngay as $item)
                        <tr >
                          ...
                          <td style="border:thin blue solid;color:red" class="text-center"><h4><b>{{date('d-m-Y',strtotime($item->lohang_ngay_nhap))}}</b></h4></td>
                          <td style="border:thin blue solid;"></td>
                      ...
                      @foreach($chi as $dt)
                        @if($item->lohang_ngay_nhap==$dt->lohang_ngay_nhap)
                        <?php 
                        $sanpham = DB::table('sanpham')->where('id',$dt->sanpham_id)->first();
                        ?>
                        <tr >
                          <td style="border:thin blue solid;border-top-style:hidden;"></td>
                          <td style="border:thin blue solid;border-top-style:hidden;" ></td>
                          <td style="border:thin blue solid;">{{$dt->lohang_ky_hieu}}</td>
                          <td style="border:thin blue solid;" class="text-center">{{$sanpham->sanpham_ten}}</td>
                          <td style="border:thin blue solid;" class="text-right">{{number_format($dt->lohang_gia_mua_vao)}}</td>
                          <td style="border:thin blue solid;" class="text-center">{{$dt->lohang_so_luong_nhap}}</td>
                          <td style="border:thin blue solid;" class="text-right">{{number_format($dt->lohang_so_luong_nhap*$dt->lohang_gia_mua_vao)}}</td>
                      </tr>
                      @endif
                      @endforeach
                      @endforeach
                  ...
                  <tr ><h4><b>
                          ...
                          <td style="border:thin blue solid;color:red" class="text-center"><strong></strong></td>
                          <td style="border:thin blue solid;color:red" class="text-right"><strong></strong></td>
                          <td style="border:thin blue solid;color:red" class="text-right"><strong>{{number_format($tonggt)}}</strong></td></h4></b>
                      </tr>
                </table>
                </div>
            </div>
