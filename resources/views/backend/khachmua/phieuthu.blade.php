      ...
      <div class="col-sm-12">
          ...
          <table style="margin-left:10px;font-size:16px;color:black">
            ...
            <div class="panel-body">
                <div class="adv-table">
                <form action="{!! route('admin.phieuthu.postkhachmua') !!}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                    <table  class="display table table-bordered table-striped" style="font-size:16px;color:black">
                        ...
                        <tbody>
                            ...
                            @else
                                <td>
                                  <input type="hidden" name="idkm" class="form-control" value="{{$khachmua->id}}">
                    ...
                    <div class="modal-footer" >
                        @if(isset($pt))
                        <a href="{!! URL::route('admin.phieuthu.pdfkm', $pt->id ) !!}" 
                        ...
                        @endif
                        <a href="{!! URL::route('admin.khachmua.list') !!}" type="button" class="btn btn-default btn-sm" ><i
